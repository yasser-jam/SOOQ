 ...
 *
 * Twin of `apps/store/lib/customer-account-api.ts` — keep both copies in sync.
 */
...
export { ADDRESS_LABEL_OPTIONS } from "@/modules/storefront/components/checkout/checkout-api"
