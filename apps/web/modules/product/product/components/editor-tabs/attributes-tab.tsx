  ...
  return (
    ...
    <Card className="border-2">
      ...
      <CardHeader className="border-b bg-gradient-to-r from-orange-50 to-amber-50">
        ...
        <CardTitle className="text-xl font-semibold">السمات المخصّصة</CardTitle>
      ...
      <CardContent className="p-6">
        ...
        {isPending ? (
          ...
          <div className="flex flex-col items-center gap-2 rounded-lg border-2 border-dashed py-10 text-center bg-gray-50">
