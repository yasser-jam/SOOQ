...
export const getAdminOrdersSummary = async (): Promise<AdminOrdersSummary> => {
	const response = await api<ApiResponse<AdminOrdersSummary>>("/admin/orders/summary")
...
export const listAdminOrders = async (
	...
	const response = await api<ApiResponse<PaginatedApiResponse<AdminOrderListItem>>>(
		"/admin/orders",
		{
			params,
		}
...
export const editAdminOrder = ({
	id,
	data,
}: EditOrderInput): Promise<void> =>
