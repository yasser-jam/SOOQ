...
| **Phase 3A** — Variant Matrix | `KV-Products` | ⬜ | 0 / 11 | Per user: all phases on KV-Products |
| **Phase 3B** — Attribute Definitions | `KV-Products` | ⬜ | 0 / 13 | Per user: all phases on KV-Products |
...
**Total:** 37 / 127 steps complete (29%)
