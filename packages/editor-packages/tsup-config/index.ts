...
// Resolve dependencies from the tsup-config package even after config bundling.
const nodeRequire = createRequire(
  new URL("../tsup-config/package.json", import.meta.url)
);
const postcss = nodeRequire("postcss") as typeof import("postcss");
const postcssModules = nodeRequire("postcss-modules") as typeof import("postcss-modules");
