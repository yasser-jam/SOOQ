...
const DEFAULT_FIELD_HELP: Partial<Record<Field["type"], string>> = {
  text: "عدّل النص أو القيمة الظاهرة لهذا العنصر.",
  textarea: "أضف نصاً أطول. حافظ على الإيجاز ليسهل على المتسوقين المسح السريع.",
  number: "استخدم رقماً بسيطاً. تنعكس التغييرات فوراً على المعاينة.",
  select: "اختر خياراً واحداً من القائمة.",
  radio: "اختر الخيار الأنسب للتنسيق الذي تريده.",
  array: "أضف أو احذف أو انسخ أو أعد ترتيب العناصر في هذه القائمة.",
  object: "عدّل مجموعة الإعدادات المترابطة هذه.",
  external: "ابحث واختر محتوى من المصدر المتصل.",
  richtext: "نسّق النص باستخدام العناوين والروابط والتشكيل.",
  custom: "استخدم عنصر التحكم المخصص هذا لتعديل العنصر.",
};
