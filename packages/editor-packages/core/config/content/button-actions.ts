...
export const BUTTON_ACTION_OPTIONS: { label: string; value: ButtonAction }[] = [
  ...
  { label: "متابعة إلى الدفع", value: "makeOrder" },
  { label: "تطبيق كود الخصم", value: "validateDiscount" },
  { label: "تأكيد الطلب", value: "placeOrder" },
...
export function buttonActionLabel(action: ButtonAction): string {
  const map: Record<ButtonAction, string> = {
    ...
    makeOrder: "متابعة إلى الدفع",
    validateDiscount: "تطبيق كود الخصم",
